...
**_Note: Python 3.6 or higher is required to run the script manually_**

**_Note: this is now deprecated. It would still work provided the path to options.json is manually set in the code manually set path at line 39: `with open('/data/options.json') as json_file`_**
